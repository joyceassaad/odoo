...
class Survey(models.Model):
    ...
    participants_can_see_votes = fields.Boolean('Participants can see votes', help="If checked, users can see the votes of other participants while voting, only for multiple choice questions.")
    # statistics
